...
print ("Characters:")
print ("Number of token in dict:",len(token2id.keys()))
...
for epoch in range(num_epochs):
    ...
    model_file = 'model_RNN_' + str(epoch+1)+'concat_hidden_300'+'.pth'
...
plt.savefig('accuracies_concat_RNN_hidden_300.png')
...
plt.savefig('losses_concat_RNN_hidden_300.png')
